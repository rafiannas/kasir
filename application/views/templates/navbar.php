                ...
                <li class="nav-item dropdown hidden-caret">
                    ...
                    <ul class="dropdown-menu dropdown-user animated fadeIn">
                        <div class="dropdown-user-scroll scrollbar-outer">
                            <li>
                                <div class="user-box">
                                    <div class="avatar-lg"> <img src="<?= base_url('assets/assets/img/profile.jpg') ?>" alt="..." class="avatar-img rounded"></div>
                                    <div class="u-text">
                                        <h4> <?= $saya_karyawan['username']; ?></h4>
                            ...
                            <li>
                                ...
                                <a class="dropdown-item" href="<?= base_url('admin/rubah_password') ?>">Rubah Password</a>
                                <div class="dropdown-divider"></div>
