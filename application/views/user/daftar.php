        ...
        <div class="col-xl-12 col-lg-12 col-md-9">
            ...
            <div class="card o-hidden border-0 shadow-lg col-lg-7 mx-auto">
                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action=" <?= base_url('user/daftar'); ?> ">
                                    <div class="form-group">

                                        <input type="text" class="form-control form-control-user" id="name" placeholder="Name" name="name" required value="<?php echo isset($submit) ? $name : '' ?>">
                ...
                <a class="small" href="forgot-password.html">Forgot Password?</a>
                                ...
                                <div class="text-center">
                                    <a class="small" href="<?= base_url('user'); ?> ">Sudah punya akun, ayo masuk!</a>
                                </div>
                            </div>
                        </div>
                    </div>
