            ...
            <div class="col-lg-6">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-info"><?= $kategori['nama_kategori']; ?></h6>
                    </div>
                    <div class="card-body">
                        <form method="post" action="<?= base_url('admin/edit_kategori'); ?>">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama" value="<?= $kategori['nama_kategori']; ?>" required>
                            </div>
