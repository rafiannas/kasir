                        ...
                        <div class="card-body">
                            ...
                            <form method="GET">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" aria-label="Harga beli" aria-describedby="username-addon" name="harga_beli" id="harga_beli" value="">
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="number" min="1" max="10000" class="form-control" name="jumlah">
                            </div>
                        </div>
