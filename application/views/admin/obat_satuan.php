        ...
        <div class="page-inner">
            <div class="page-header">
                ...
                <ul class="breadcrumbs">
                    ...
                    <li class="nav-item">
                        <a href="#"><strong>Satuan Obat</strong></a>
                    </li>
                </ul>
            </div>
            <div class="row">
                        ...
                        <div class="card-header">
                            <div class="row row-nav-line">
                                <ul class="nav nav-tabs nav-line nav-color-primary w-100 pl-4" role="tablist">
                                    ...
                                    <li class="nav-item"> <a class="nav-link active show" href="<?= base_url('admin/obat_satuan'); ?>" role="tab" aria-selected="false">Satuan Obat</a> </li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($obatsatuan as $s) : ?>
                                            <tr>
                                                ...
                                                <td><?= $s['satuan']; ?></td>
                                                <td align="center">
                                                    <a href="<?= base_url('admin/edit_satuan/'); ?><?= $s['id']; ?>" class="btn btn-success btn-sm editsatuan" data-toggle="modal" data-target="#edit" data-id="<?= $s['id']; ?>"><i class="fas fa-edit"></i></a>
                                                </td>
                                            </tr>
                                        <?php $i += 1;
                                        endforeach; ?>
...
<div class="modal fade" id="tambahsatuan" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/obat_satuan/'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group form-group-default">
                                ...
                                <input type="text" class="form-control" name="satuan" placeholder="Masukkan satuan, contoh: ml, mg" required>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/edit_satuan/'); ?>" method="post" enctype="multipart/form-data">
